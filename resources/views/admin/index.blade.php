                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2 rounded-circle">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">Jumlah jadwal</p>
                                <h4 class="mb-0">{{ $jadwal->count() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2 rounded-circle">
                            ...
                            <div class="text-end pt-1 ">
                                <p class="text-sm mb-0 text-capitalize">Jumlah Instruktur</p>
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2 rounded-circle">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">{{ $sekolah->count() }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tbody>
                                                @foreach ($jadwal as $jdl)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <p class="text-xs text-secondary mb-0">
                                                                @foreach ($jdl->sekolah as $sekolah)
                                                                    {{ $sekolah->nama }}
                                                                @endforeach
                                                            </p>
                                                        </td>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <p class="text-xs text-secondary mb-0">{{ $jdl->tanggal }}
                                                            </p>
                                                        </td>
                                                        <td class="align-middle text-center">
                                                            <p class="text-xs text-secondary mb-0 ">
                                                                @foreach ($jdl->asisten as $asisten)
                                                                    {{ $asisten->name }}
                                                                @endforeach
                                                            </p>
                                                        </td>
