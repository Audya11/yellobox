                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($sekolahs as $sekolah)
                                            <tr>
                                                <td>
                                                    <p class="text-secondary text-xs text-center font-weight-bold">
                                                        {{ $sekolah->nama }}</p>
                                                </td>
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="text-secondary text-xs font-weight-bold">{{ $sekolah->pic }}
                                                    </p>
                                                </td>
                                                <td
                                                    class="align-middle text-center justify-content-center align-items-center d-flex">
